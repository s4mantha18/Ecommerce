...
<body>
    ...
    <div class="slideshow-container" id="top">
        <div class="mySlides fade">
            ...
            <div class="text">WELCOME TO SAM'S FASHION JERSEYS</div>
            <div class="bg-image" style="background-image: url('Comp 1_0000011.jpg');"></div>
        </div>
        <div class="mySlides fade">
            <div class="overlay"></div>
            <div class="text">HIGH QUALITY JERSEYS FOR EVERY SPORT</div>
            <div class="bg-image" style="background-image: url('Comp 1_000002.jpg');"></div>
        </div>
        <div class="mySlides fade">
            <div class="overlay"></div>
            <div class="text">DISCOVER OUR NEW COLLECTION</div>
            <div class="bg-image" style="background-image: url('Comp 1_00000.jpg');"></div>
        </div>
